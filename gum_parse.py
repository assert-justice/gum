...
def parse(create, build, run, install, acp, add, version):
    ...
    group.add_argument("-t","--target", choices=["win","osx","gnu"], help="Specify compile target if different than current machine. Not yet implemented.")
    build_parser.add_argument("-o", type=int, choices=[0,1,2,3], default=0, help="Override the default optimization level.")

    build_parser = subparsers.add_parser("run", aliases=["r"], help="Builds and runs the project assuming no errors or warnings. All commands work identically.")
